        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to='/my-generation' className="hover:text-pink-500 transition">My geneartion</Link> 
                    <Link to='#' className="hover:text-pink-500 transition">Contact</Link> 
                    
                </div>

                <button onClick={()=>navigate('/')} className="hidden md:block px-6 py-2.5 bg-pink-600 hover:bg-pink-700 active:scale-95 transition-all rounded-full">
                    Get Started
                </button>
